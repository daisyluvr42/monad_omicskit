...
- `monadomics-0.2.2-py3-none-any.whl`：Python 运行包，包含 R 脚本，可本地安装。
- `monadomics-0.2.2.tar.gz`：Python 源码分发包。
- `monadomics-workbuddy-0.2.2.zip`：WorkBuddy CLI 连接器包，一个主 Skill。
...
2. 发布固定版本 `monadomics==0.2.2` 到 PyPI。
